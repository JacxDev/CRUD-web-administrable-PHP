      ...
      <div class="sidebar-search">
        <div>
          <div class="input-group">
            <form class="search-menu" action="<?php echo RUTA; ?>/buscar.php" method="get" name="busqueda" class="buscar">
        ...
        <ul>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="nuevo.php">Nuevo Post

                  </a>
                </li>
                <li>
                  <a href="../admin/editar.php">Post's</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="nueva.vacante.php">Nueva Vacante</a>
                </li>
                <li>
                  <a href="../admin/index.vacantes.php">Administrar Vacantes</a>
                </li>
              </ul>
            </div>
          </li>
